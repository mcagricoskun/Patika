...
public class StringClassMethods {
    public static void main(String[] args) {
        ...
        contentEquals() -- Bir dizenin belirtilen CharSequence veya StringBuffer ile aynı karakter dizisini içerip içermediğini kontrol eder
        ...
        format() --------- Belirtilen yerel ayan, biçim dizesini ve bağımsız değişkenleri kullanarak biçimlendirilmiş bir dize döndürür
        getChars() ------- Karakterleri bir dizeden bir karakter dizisine kopyalar
        indexOf() -------- Bir dizede belirtilen karakterlerin ilk bulunan oluşumunun konumunu verir
        isEmpty() -------- Bir dizenin boş olup olmadığını kontrol eder
        lastIndexOf() ---- Bir dizede belirtilen karakterlerin son bulunan oluşumunun konumunu verir
        length() --------- Belirtilen bir dizenin uzunluğunu verir
        matches() -------- Normal bir ifadeye karşı bir eşleşme için bir dize arar ve eşleşmeleri döndürür
        ...
        substring() ------ Karakterleri bir dizeden, belirtilen bir başlangıç konumundan başlayarak ve belirtilen karakter sayısıyla ayıklar
        toString() ------- Bir String nesnesinin değerini verir
        toUpperCase() ---- Bir dizeyi büyük harflere dönüştürür
        trim() ----------- Bir dizenin her iki ucundaki boşluğu kaldır
        compareTolgnoreCase() Büyük/ küçük harf farklılıklarını göz ardı ederek iki dizgeyi sözlükbilimsel olarak karşılaştırır int
