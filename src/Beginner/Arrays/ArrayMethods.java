...
public class ArrayMethods {
    public static void main(String[] args) {
        /*Beginner.Arrays Sınıfı ve Metotları
        Java.util paketindeki Beginner.Arrays sınıfı, Java Collection Framework'ün bir parçasıdır.
        ...
        //Import deyimi ile java.util.Beginner.Arrays sınıfını projeye dahil etmemiz gerekmektedir.

        //Beginner.Arrays.toString()
        ...
        //Beginner.Arrays.fill()
        //Beginner.Arrays.fill metodu ile dizilerimizin belirli bir bölümlerine değerler atayabiliriz.
        ...
        // Beginner.Arrays.sort()
        // Beginner.Arrays.sort() metodu ile dizilerdeki elemanları sıralayabiliriz.
        ...
        // Beginner.Arrays.copyOf() ve Beginner.Arrays.copyOfRange() metotu
        //Mevcut diziden belli bir uzunlukta yeni bir dizi oluşturmak için Beginner.Arrays.copyOf() metotu kullanılır
        ...
        //Beginner.Arrays.equals() metotu
        //Java'da iki dizinin eşitliğini kontrol etmek için Beginner.Arrays.equals() metotu kullanılır.
